...
export function RoomList({ rooms, onSelectRoom, activeRoomId }: RoomListProps) {
    return (
        <div className="flex flex-col h-full bg-white dark:bg-gray-900">
            <header className="px-4 py-3 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10 dark:bg-gray-900 dark:border-gray-800">
                        ...
                        >
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-xs text-opacity-70 opacity-70 truncate max-w-[200px]">
                                    {isAnnouncement ? 'Read-only announcements' : 'General discussion'}
                                </p>
                            </div>
