      ...
      {!hideHeader && (
        <header className="bg-emerald-600 pt-safe text-white shadow-md z-10 shrink-0 sticky top-0">
          <div className="h-[60px] px-4 flex items-center justify-between">
            ...
            {isSyncing && (
              <div className="flex items-center gap-1.5 bg-white/10 px-2 py-0.5 rounded-full border border-white/20 animate-pulse">
                <svg className="animate-spin h-3 w-3 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <span className="text-[10px] font-medium text-white tracking-wide">SINCRONIZZAZIONE</span>
              </div>
            )}
          </div>
        </header>
