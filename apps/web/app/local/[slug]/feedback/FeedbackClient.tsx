        ...
        <div className="flex flex-col h-screen bg-gray-50 w-full">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm text-primary">
                    <Icon name="List_Checklist" className="w-10 h-10" />
                </div>
                <h3 className="text-lg font-bold text-gray-600">Coming Soon</h3>
                <p className="max-w-xs text-sm text-gray-500 mt-2">La funzione di feedback sarà disponibile a breve per {tenant?.name}.</p>
            </div>
        </div>
    );
}
