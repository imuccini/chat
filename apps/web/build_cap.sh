...
# 3. Copy web assets to native projects + inject custom plugins
echo "📱 Syncing to Capacitor..."
npx cap sync ios

# 4. Inject custom native plugins (single source of truth in scripts/inject-cap-plugins.mjs)
node scripts/inject-cap-plugins.mjs ios
